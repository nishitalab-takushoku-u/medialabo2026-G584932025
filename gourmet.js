...
let gurumeData = {
  "mise":{
    "shop":[
        ...
        "access": "新宿駅西口より徒歩5分、大江戸線新宿西口駅（D5出口）より徒歩2分",
        "address": "東京都新宿区西新宿7-16-12　YSビル　B1F",
        "name": "新宿焼肉 牛たんの檸檬 総本店",
        "budget": {"name": "☀️¥1,000~¥1,999　🌙¥5,000~¥5,999"},
        "catch": "二時間半以上の宴会可、お祝い・サプライズ可",
        "open": "月・火・水・木・：11:30-15:00、17:00-22:00(L.O. 21:00)金・土(L.O. 21:45)🟧定休日：不定休",
        "genre": {"name": "牛タン、焼肉、ホルモン"},
        "station_name": "西武新宿駅"},
        {
        "logo_image": "practice-html/yakiniku.png",
        "access": "【新宿駅東口から地上ルート】→新宿駅東口交差点を渡り GUCCIとみずほ銀行の間の道を直進→靖国通りに出たら信号を渡って右に→歌舞伎町東通りに入り少し進むと到着",
        "address": "東京都新宿区歌舞伎町1-6-14　第2ショーリビル　2F",
        "name": "和牛焼肉食べ放題 肉屋の台所 新宿店",
        "budget": {"name": "☀️¥6,000~¥7,999　🌙¥6,000~¥7,999"},
        "catch": "お祝いに最適！メッセージ付きの<strong>★「肉パフェ」「肉ケーキ」★",
        "open": "平日：12:00~15:00、16:00~23:00　土・日・祝日：12:00~23:00 ",
        "genre": {"name": "焼肉、ビュッフェ、居酒屋"},
        "station_name": "新宿駅西口",
    }
  ]
  }
